...
This is an official implementation for WCE Workshop in ICPR paper ["Influence of color correction on pathology detection in Capsule Endoscopy"](https://link.springer.com/chapter/10.1007/978-3-031-88220-3_26). 
...
Table 3. Retinanet: IoU comparison across the three different color schemes.
|                                                |         |         |         |       |      |
|------------------------------------------------|---------|---------|---------|-------|------|
...
Table 4. Total number of False Positives. For the selected pathologies, both color cor- rections (R-CCD, R-CCCD) generally increase the number of false positives generated by the model compared to without color correction (R- OrigD). 

|                       | Retinanet |       |        | YOLOv5  |       |        |
|-----------------------|-----------|-------|--------|---------|-------|--------|
| Pathology             | R-OrigD   | R-CCD | R-CCCD | R-OrigD | R-CCD | R-CCCD |
| Erosion               | 130       | 250   | 225    | 220     | 239   | 247    |
| Polyp-like            | 122       | 124   | 90     | 128     | 145   | 138    |
| Erythema              | 148       | 234   | 212    | 87      | 93    | 105    |
| Bleeding              | 34        | 65    | 63     | 18      | 17    | 22     |
| Total False Positives | 434       | 673   | 590    | 453     | 494   | 512    |
